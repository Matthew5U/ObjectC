...
if ( isset( $_POST['send'] ) ) {
	...
	} elseif ( $email && ! filter_var($email, FILTER_VALIDATE_EMAIL) ) { // czy pole email posiada wartosc | filter_var - filtruje zmienna | FILTER_VALIDATE_EMAIL - sprawdza czy email pasuje do schematu
  				...
  				<div class="five wide column">
					...
					<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="ui form">
						...
						<div class="required field">
							...
							<?php } ?>
							<input type="text" name="password" id="password" value=" <?php echo $email; ?>">
						</div>
						...
						<div class="required field">
							...
							<?php } ?>
								<input class="hidden" tabindex="0" type="checkbox" name="terms"  id="terms" <?php echo (isset($_POST['terms']) ? 'checked="checked"' : '') /* zaznaczenie checkboxa*/  ?> >
